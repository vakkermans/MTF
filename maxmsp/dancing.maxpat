...
,
		"rect" : [ 25.0, 69.0, 939.0, 660.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 69.0, 939.0, 660.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"patching_rect" : [ 510.0, 345.0, 80.0, 35.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 450.0, 390.0, 221.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b b erase",
					"patching_rect" : [ 495.0, 315.0, 65.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"patching_rect" : [ 450.0, 420.0, 45.0, 45.0 ],
					"numinlets" : 2,
					"numoutlets" : 0,
					"id" : "obj-108"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.videoplane foo2",
					"patching_rect" : [ 720.0, 375.0, 116.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "sync $1",
					"patching_rect" : [ 1095.0, 300.0, 50.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 1095.0, 270.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"id" : "obj-99"
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "fullscreen $1",
					"patching_rect" : [ 1020.0, 300.0, 76.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 1020.0, 270.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"id" : "obj-25"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sel 27",
					"patching_rect" : [ 960.0, 300.0, 41.0, 20.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "key",
					"patching_rect" : [ 960.0, 270.0, 46.0, 20.0 ],
					"numinlets" : 0,
					"fontsize" : 11.595187,
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.window foo2 @depthbuffer 1 @size 1024 768",
					"patching_rect" : [ 960.0, 330.0, 257.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 525.0, 180.0, 80.0, 60.0 ],
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-8"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 749.0, 210.0, 46.0, 20.0 ],
					"numinlets" : 3,
					"fontsize" : 12.0,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "settings",
					"patching_rect" : [ 839.0, 150.0, 52.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "open",
					"patching_rect" : [ 749.0, 150.0, 34.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "close",
					"patching_rect" : [ 794.0, 150.0, 36.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"patching_rect" : [ 900.0, 180.0, 145.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"patching_rect" : [ 749.0, 180.0, 145.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 644.0, 150.0, 50.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "qmetro 15",
					"patching_rect" : [ 614.0, 180.0, 63.0, 20.0 ],
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 615.0, 210.0, 110.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 615.0, 240.0, 99.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p mask_input",
					"patching_rect" : [ 720.0, 330.0, 82.0, 20.0 ],
					"numinlets" : 3,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 405.0, 210.0, 259.0, 20.0 ],
									"numinlets" : 2,
									"fontsize" : 12.0,
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.gl.slab foo2 @file cf.blur.jxs @param width 2",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b 1 b",
					"patching_rect" : [ 645.0, 330.0, 46.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 615.0, 270.0, 300.0, 20.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-79", 0 ],
					"hidden" : 0,
					"midpoints" : [ 550.5, 339.0, 459.5, 339.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-21", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1029.5, 325.0, 969.5, 325.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-21", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1104.5, 325.0, 969.5, 325.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-25", 0 ],
					"hidden" : 0,
					"midpoints" : [ 969.5, 315.0, 1009.0, 315.0, 1009.0, 269.0, 1029.5, 269.0 ]
				}
