...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 480.0, 375.0, 25.0, 25.0 ],
									"id" : "obj-4",
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 195.0, 270.0, 116.0, 60.0 ],
									"id" : "obj-1",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.gl.slab foo2 @file op.add.jxs",
									"fontsize" : 12.0,
									"numinlets" : 2,
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 330.0, 195.0, 173.0, 20.0 ],
									"id" : "obj-167",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.gl.slab foo2 @file op.sub.jxs @param in2scale 1.1",
									"fontsize" : 12.0,
									"numinlets" : 2,
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 270.0, 150.0, 289.0, 20.0 ],
									"id" : "obj-163",
									"fontname" : "Arial"
								}
