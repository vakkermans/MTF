...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.videoplane foo2 @layer 3 @scale 1.333 1. 1. @depth_enable 0 @blend_enable 1 @blend_mode 1 0",
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
					...
					"patching_rect" : [ 150.0, 735.0, 554.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab foo2 @file tp.slide.jxs @param slide_down 20",
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
					...
					"patching_rect" : [ 450.0, 450.0, 304.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 660.0, 480.0, 99.0, 20.0 ]
				}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.gl.slab foo2 @file op.sub.jxs @param in2scale 1.4",
									"id" : "obj-163",
									"fontname" : "Arial",
									"numinlets" : 2,
									"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "int", "", "" ],
					"items" : [ "DV Video", ",", "IIDC FireWire Video", ",", "Google Camera Adapter 0", ",", "Google Camera Adapter 1", ",", "USB Video Class Video", ",", "Sony HD Eye for PS3 (SLEH 00201)" ],
					"types" : [  ],
